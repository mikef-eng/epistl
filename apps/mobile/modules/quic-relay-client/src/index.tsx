...
import installer from './NativeQuicRelayClient';
...
export * from './generated/quic_relay_client';

// Now import the bindings so we can:
// - intialize them
// - export them as namespaced objects as the default export.
import * as quic_relay_client from './generated/quic_relay_client';
...
if (!initialized) {
  quic_relay_client.default.initialize();
  initialized = true;
}
